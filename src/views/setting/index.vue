        ...
        <div class="left">
          ...
          <div class="info">
            ...
            <div class="extra-info">
              <span v-if="profile.vipType == 0" class="vip">
                <img
                  class="cvip"
              ...
              <span v-else class="text">{{ profile.signature }}</span>
            </div>
          </div>
        </div>
        <div class="right">
...
export default {
  ...
  computed: {
    ...
    ...mapState('pcSetting', ['theme', 'musicLanguage']),
    appearance: {
      get() {
        if (this.theme === undefined) return 'auto'
        return this.theme
      },
      set(value) {
        this.$store.commit('CHANGE_PCSETTING', {
          key: 'appearance',
          value
        })
